...
namespace SubjectManagementSystem.Repository.Migrations
{
    ...
    [Migration("20220124002511_fix-report-table")]
            ...
            modelBuilder.Entity("SubjectManagementSystem.Domain.Report", b =>
                {
                    ...
                    b.Property<int>("IdProblemChallenge")
                        .HasColumnName("id_problem_challenge")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SubjectManagementSystem.Domain.Report", b =>
                {
                    ...
                    b.HasOne("SubjectManagementSystem.Domain.ProblemChallenge", "ProblemChallenge")
                        .WithMany()
                        .HasForeignKey("IdProblemChallenge")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
